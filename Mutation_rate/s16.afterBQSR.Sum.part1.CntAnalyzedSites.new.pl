...
my $out = "$cnt.analyzed_sites.tbl";
open(SITE_OUT,">","$out") or die "Can't open $out: $!";
...
close(SITE_OUT) or die "Can't close $out: $!";
...
$out = "$cnt.error_rate.tbl";
open(ERR_OUT,">","$out") or die "Can't open $out: $!";
print ERR_OUT "A Err = $ErrA\tAll = $AllA\n";
print ERR_OUT "C Err = $ErrC\tAll = $AllC\n";
print ERR_OUT "G Err = $ErrG\tAll = $AllG\n";
print ERR_OUT "T Err = $ErrG\tAll = $AllT\n";
close(ERR_OUT) or die "Can't close $out: $!";
